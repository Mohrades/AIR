...
public class AddPeriodicAccountManagementData {
	...
	public AddPeriodicAccountManagementData(AIRRequest air) {
		super();
		this.air = air;
	}
    
	public void formerRequete(String number,String originOperatorID, String pamClassID, String pamServiceID, String pamScheduleID){
        
		requete=new StringBuffer("<?xml version=\"1.0\"?><methodCall><methodName>AddPeriodicAccountManagementData</methodName><params><param><value><struct><member><name>originHostName</name><value><string>BJDTSRVAPP001</string></value></member><member><name>originNodeType</name><value><string>EXT</string></value></member>");
