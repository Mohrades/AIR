...
public class DeletePeriodicAccountManagementData {
	...
	public DeletePeriodicAccountManagementData(AIRRequest air) {
		super();
		this.air = air;
	}
	
	public void formerRequete(String number,String originOperatorID, int pamClassID, int pamServiceID, int pamScheduleID){
        
		requete=new StringBuffer("<?xml version=\"1.0\"?><methodCall><methodName>DeletePeriodicAccountManagementData</methodName><params><param><value><struct><member><name>originHostName</name><value><string>BJDTSRVAPP001</string></value></member><member><name>originNodeType</name><value><string>EXT</string></value></member>");
    ...
    Scanner sortie= new Scanner(reponse);
        while(true){
            ...
            if(ligne==null) {
                ...
                this.responseCode = Integer.parseInt(code_reponse.substring(11, last));
