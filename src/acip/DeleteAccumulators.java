...
public class DeleteAccumulators {
    ...
    public boolean delete(AIRConnector air, String msisdn,Integer serviceClassCurrent ,HashSet<AccumulatorInformation> accumulatorIdentifier,String originOperatorID){
