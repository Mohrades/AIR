...
public class GetUsageThresholdsAndCounters {
    ...
    public GetUsageThresholdsAndCounters(AIRRequest air){
    	 this.air=air;
    }
    public void formerRequete(String number,String originOperatorID){
    	
    	requete=new StringBuffer("<?xml version=\"1.0\"?><methodCall><methodName>GetUsageThresholdsAndCounters</methodName><params><param><value><struct><member><name>originNodeType</name><value><string>EXT</string></value></member><member><name>originHostName</name><value><string>BJDTSRVAPP001</string></value></member><member><name>originTransactionID</name><value><string>");
    ...
    public HashSet<UsageCounterUsageThresholdInformation> getValues(){
