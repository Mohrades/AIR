...
public class UpdateServiceClass {
    ...
    public StringBuffer formerRequete(String msisdn,String serviceClassAction,int serviceClassNew,int serviceClassTemporaryNew,Date serviceClassTemporaryNewExpiryDate,String originOperatorID){ 
        ...
        if(serviceClassTemporaryNewExpiryDate==null);
            ...
            date.append((new DateTime_iso8601()).format(serviceClassTemporaryNewExpiryDate,false));
        ...
        StringBuffer requete = new StringBuffer("<?xml version=\"1.0\"?><methodCall><methodName>UpdateServiceClass</methodName><params><param><value><struct><member><name>originNodeType</name><value><string>EXT</string></value></member><member><name>originHostName</name><value><string>BJDTSRVAPP001</string></value></member><member><name>originTransactionID</name><value><string>");
